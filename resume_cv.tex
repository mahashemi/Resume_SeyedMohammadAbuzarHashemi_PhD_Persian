...
\name{Mohammad {Abuzar}}{Hashemi}
% \address{57 St. Joseph Street 2911, Toronto, ON, Canada}
\mobile{(716)-536-7993}

\email{ma.hashemi.786@gmail.com}
\homepage{https://scholar.google.com/citations?user=QPPohkgAAAAJ&hl=en}
...
\position{Artificial Intelligence (AI) Researcher} % Your expertise/fields


\makecvfooter{\today}{{Mohammad Abuzar} Hashemi~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
% \input{cv-sections/teachings.tex}
